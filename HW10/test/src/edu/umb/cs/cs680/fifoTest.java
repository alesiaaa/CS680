...
public class fifoTest {
	...
	public void initilizeFifoCacheTest() {
		...
		assertThat(cut.getCacheReplacementPolicy()==null, is(true));
		
		cut.setCacheReplacementPolicy(new FIFO());
		assertThat(cut.getCacheReplacementPolicy()==null, is(false));
	...
	public void checkExceptionFifoCacheTest() throws CacheReplacementPolicyException {
		cut.setCacheReplacementPolicy(null);
		cut.clearCache();
		...
		assertThat(cut.getCacheContent(), is(10));
	}
}
