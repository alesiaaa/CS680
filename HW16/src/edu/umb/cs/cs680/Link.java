...
public class Link extends FSElement{
	...
	public FSElement getLinkElement() {
		
		FSElement foundElement = null;
		
		if (!this.actualElement.isLink()){
			// File or directory
			foundElement = actualElement;
			
		} else if (this.actualElement.isLink()){
			// Link
			Link link1 = (Link) this.actualElement;
			
			// Call function recursively until the file or directory is found
			link1.getLinkElement();
